 ...
 * @file film.js
 * @description
 * Файл содержит реализацию различных утилитарных функций для работы с фильмами, таких как форматирование даты, продолжительности и сортировка фильмов по различным критериям (дата, рейтинг, количество комментариев).
 * Эти функции используются в различных частях приложения для отображения информации о фильмах и управления ими.
 */
